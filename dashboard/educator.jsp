...
<%
    ...
    String roleId = (u.getRoleId() != null) ? u.getRoleId() : "R002";
...
<head>
    ...
    <title>Educator Dashboard | NumSolve</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .btn-blue { background: var(--blue); color: var(--white); box-shadow: 0 8px 15px rgba(59, 130, 246, 0.3); }
        .btn-blue:hover { background: #2563eb; transform: translateY(-3px); box-shadow: 0 12px 20px rgba(59, 130, 246, 0.4); }
        ...
        .btn-primary:hover { background: var(--primary-hover); transform: translateY(-3px); box-shadow: 0 12px 20px rgba(139, 92, 246, 0.4); }
        ...
        .btn-cyan { background: var(--cyan); color: var(--white); box-shadow: 0 8px 15px rgba(14, 165, 233, 0.3); }
        .btn-cyan:hover { background: #0284c7; transform: translateY(-3px); box-shadow: 0 12px 20px rgba(14, 165, 233, 0.4); }
...
<body class="<%= roleClass %>">
    ...
    <nav class="top-nav animated-nav">
        ...
        <ul class="nav-menu">
            <li><a href="${pageContext.request.contextPath}/educator/educator.jsp" class="nav-link active"><i class='bx bxs-dashboard'></i> <span>Dashboard</span></a></li>
    ...
    <main class="main-content">
        ...
        <div class="header-area animated-panel delay-1">
            <div>
                <h2>Hello, Educator <%= u.getFullName() %> <span style="font-size: 2.5rem;">👋</span></h2>
                <p>Welcome to your control center. Ready to inspire your students today?</p>
            </div>
        ...
        <div class="grid animated-panel delay-2">
            ...
            <div class="card card-blue">
                ...
                <h3>Quick Compute</h3>
                <p>Start a new numerical analysis calculation and generate step-by-step solutions.</p>
                <a href="${pageContext.request.contextPath}/solver.jsp" class="btn btn-blue">Start Calculation <i class='bx bx-right-arrow-alt'></i></a>
            </div>
            
            <div class="card card-green">
                <div class="icon-box"><i class='bx bxs-bulb'></i></div>
                <h3>Recommend Engine</h3>
                <p>Use the recommendation engine to find the most accurate numerical approach.</p>
                <a href="${pageContext.request.contextPath}/recommendation.jsp" class="btn btn-green">Find Method <i class='bx bx-right-arrow-alt'></i></a>
            </div>
            
            <div class="card card-orange">
                <div class="icon-box"><i class='bx bxs-edit'></i></div>
                <h3>Manage Missions</h3>
                <p>Create quizzes, assign missions to classes, and evaluate student performance.</p>
                <a href="${pageContext.request.contextPath}/educatorQuizzes" class="btn btn-orange">View Missions <i class='bx bx-right-arrow-alt'></i></a>
            </div>

            <div class="card card-purple">
                <div class="icon-box"><i class='bx bxs-school'></i></div>
                <h3>My Classes</h3>
                <p>Manage your classrooms, generate class codes, and track enrolled students.</p>
                <a href="${pageContext.request.contextPath}/manage_classes.jsp" class="btn btn-primary">Manage Classes <i class='bx bx-right-arrow-alt'></i></a>
            </div>

            <div class="card card-cyan">
                <div class="icon-box"><i class='bx bxs-book-reader'></i></div>
                <h3>Learning Materials</h3>
                <p>Upload new study resources, notes, and video tutorials for your students.</p>
                <a href="${pageContext.request.contextPath}/educator/my_materials.jsp" class="btn btn-cyan">Manage Materials <i class='bx bx-right-arrow-alt'></i></a>
            </div>
            
            <div class="card card-red">
                <div class="icon-box"><i class='bx bxs-time-five'></i></div>
                <h3>Past Records</h3>
                <p>Review calculation history and export numerical analysis performance reports.</p>
                <a href="${pageContext.request.contextPath}/computations.jsp" class="btn btn-red">View Records <i class='bx bx-right-arrow-alt'></i></a>
            </div>
        </div>
    </main>
</body>
